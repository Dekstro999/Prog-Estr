...
void ordenarBurbuja(Alumno alumnos[], int numAlumnos)
{
    for (int i = 0; i < numAlumnos - 1; i++)
    {
        ...
        {
            if (alumnos[j].key > alumnos[j + 1].key)
            {
